        ...
        <div className="start-screen">
            ...
            <div className="content">
                <div className="column">
                    ...
                    <h2 >for mobile</h2>
                    <p>For the best experience, use the mobile device to draw and control the ball by tilting, shaking, and twisting it.To view the actions of other players, look at the game on the desktop screen.</p>
                </div>
                <div className="column">
                    ...
                    <h2>for desktop</h2>
                    <p>This screen is for viewing only and doesn’t include interactive controls on your desktop. To control the game—such as moving the ball and drawing—please use a mobile device. On your mobile, you can interact with the game, while the desktop will display the actions of all players."</p>
                </div>
            </div>
            <button className="start-button" onClick={handleClick}>Let's Begin</button>
        </div>
    );
};
